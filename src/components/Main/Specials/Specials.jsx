...
const foodItems = [
  {
    ...
    price: "$12.99",
    description:
      "The famous greek salad of crispy lettuce, peppers, olives and our Berlin style feta cheese, garnished with crunchy garlic and rosemary croutons. ",
  ...
  return (
    <div className="app__specials">
      <div className="app__specials-title-and-btn">
        ...
        <h2 className="app__specials-title">Online Menu</h2>
      </div>
